...
<div class="container">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4>Yeni Who We Do Item Yarat</h4>
        ...
        <div class="card-body">
            <form action="{{ route('admin.whoWeDoItem.store') }}" method="POST" id="saveForm">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="who_we_do_id" class="form-control">
                        ...
                        @foreach($whoWeDos as $whoWeDo)
                            <option value="{{ $whoWeDo->id }}">{{ $whoWeDo->translate(app()->getLocale())?->title }}</option>
                        @endforeach
                    </select>
                </div>
